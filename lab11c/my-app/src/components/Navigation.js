...
const Button1 = styled(NavButton)` 
    background: #F25F5C; 
    &:hover { 
        background: #9B3D3B; 
...
const Button2 = styled(NavButton)` 
    background: #867636; 
    &:hover { 
        background: #594E24;
    } 
...
const Button3 = styled(NavButton)` 
    background: #404E7C;
    &:hover { 
        background: #29324F;
    } 
...
const Navigation = (props) => {
    ...
    const AnimatedNavigation = styled.nav`animation: 1s ${slideAnimation};`;
    return (
        <AnimatedNavigation>
            <Link to='/styles'>
            ...
            <Link to='/antd'>
                <Button2>Antd</Button2>
            </Link>
            <Link to='/recharts'>
                <Button3>Recharts</Button3>
            </Link>            
        </AnimatedNavigation>  
    );
